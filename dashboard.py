...
if __name__ == '__main__':
	...
	if df is None:
		st.markdown(body="""Run test dataset analysis OR upload a dataset of posts (currently Twitter only supported). Remind you that results of analysis depends on the
